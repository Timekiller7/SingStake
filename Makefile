...
watch: requires_nix_shell
	while sleep 1; do find src Ex.cabal | entr -cd make build; done
...
build_path = dist-newstyle/build/x86_64-linux/ghc-8.10.4.20210212/Ex-0.1
clear_build:
